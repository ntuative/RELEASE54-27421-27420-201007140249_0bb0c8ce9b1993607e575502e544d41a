package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1684:String = "hot_looks";
      
      public static const const_1635:String = "my_looks";
       
      
      private var var_413:Dictionary;
      
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         super(param1);
         var_413 = new Dictionary();
         var_413["null"] = new Array();
         var_413["null"] = new Array();
         var_413["undefined.index"] = 0;
         var_413["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_413[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
