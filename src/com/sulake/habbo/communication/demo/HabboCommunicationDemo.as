package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_193:HabboHotelView;
      ...
      private var var_2399:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1718:ILogger;
      ...
      private var var_477:IKeyExchange;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1191)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_160);
         }
         var_2398 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2398)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_833 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_833);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_177);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         var_1191 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_237);
         connection.send(new VersionCheckMessageComposer(401,var_1480,var_2397));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1494,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_477.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_477.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2399);
      ...
      {
         var_833 = _habboConfiguration.getKey("sso.ticket",null);
         var_1480 = _habboConfiguration.getKey("flash.client.url","");
         var_2397 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_193 == null)
         {
            var_193 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_833 != null)
         {
            var_64.mode = HabboConnectionType.const_376;
            var_64.initConnection(HabboConnectionType.const_278);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1718 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_700);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2399 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_376:
               _loc6_ = "";
               ...
               var_1190 = _loc4_;
               var_193.loadBannerImage(_loc7_ + "?token=" + var_1190,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_992:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1423:
               var_687 = generateRandomHexString(30);
               var_477 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_477.init(var_687);
               _loc8_ = var_477.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_193.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1190);
         ...
         var_477 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_477.init(_loc14_);
            _loc15_ = var_477.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_992;
            }
         }
         var_64.initConnection(HabboConnectionType.const_278);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_202);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_101,onRoomSessionEnded);
      }
