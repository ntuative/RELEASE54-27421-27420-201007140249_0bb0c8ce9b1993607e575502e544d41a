package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_774:String = "tile_cursor";
      ...
      private static const const_363:String = "place_holder";
      
      private static const const_1089:String = const_363;
      ...
      public static const const_549:String = "RCL_LOADER_READY";
      ...
      private var var_1053:IEventDispatcher = null;
      
      private var var_1256:Map = null;
      ...
      private var var_1812:Array;
      
      private var var_354:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_500 = [];
         _wallItems = [];
         var_1812 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1816 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_300,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_143 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_391.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_176 != null && var_176.hasWorldType(const_297 + param1))
         {
            return var_176.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_354 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_354.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_601.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_363,const_514,ROOM_CONTENT,const_774,const_776];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_28 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(var_499.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1812.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_159 && _loc5_ != RoomObjectLogicEnum.const_143)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_498.getValue(param1) as String;
      ...
      {
         if(var_600.getValue(param1) != null)
         {
            return var_600.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1816.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1256.add(_loc5_,_loc8_);
               var_176 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_300,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_488,_loc5_);
         }
      ...
      {
         var _loc3_:String = var_497.getValue(param1) as String;
      ...
      private function continueInitilization() : void
      {
         if(var_1814)
         {
            ...
            if(var_1053 != null)
            {
               var_1053.dispatchEvent(new Event(const_549));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_176 != null)
         {
            return var_176.getWorldHeightScale(const_297 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_600.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_498.add(_loc3_,_loc4_);
               if(var_500.indexOf(_loc7_) < 0)
               {
                  var_500.push(_loc7_);
               }
            }
            ...
            _loc8_ = var_499.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_499.remove(_loc7_);
               var_499.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1053 = param1;
         var_1813 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_1817 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_1818 = param2.getKey("public.room.dynamic.download.url","");
         var_1815 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_38 = const_775;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_354.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_159 && _loc5_ != RoomObjectVisualizationEnum.const_143)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_465.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_354.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_297 + param1) == RoomObjectCategoryEnum.const_63)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1256.getValue(param1) != null)
         {
            var_176 = var_1256.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_487,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_176 != null)
         {
            return var_176.getWorldScale(const_297 + param1);
         }
         return 32;
      }
   }
