package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_512:String = "default";
      ...
      private var var_337:Map = null;
      
      private var var_965:IGraphicAssetCollection = null;
      
      private var var_110:Map = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_965.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_183.getValue(_loc6_) == null)
               {
      ...
      {
         return var_337.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_110 != null)
         {
            ...
            {
               _loc2_ = var_110.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_337.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_183.getValue(param1) as PlaneTexture;
      }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = var_183.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(var_110.getValue(param1) == null)
         {
            var_110.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_337.length)
         {
            _loc3_ = var_337.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
