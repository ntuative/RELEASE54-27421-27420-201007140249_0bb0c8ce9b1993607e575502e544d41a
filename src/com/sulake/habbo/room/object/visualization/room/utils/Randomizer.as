package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1699:int = 16777216;
      
      public static const const_1659:int = 1;
       
      
      private var var_2510:int = 69069;
      
      private var var_1445:int = 1;
      
      private var var_2511:int = 5;
      
      private var var_1678:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1678 * param2);
      }
      ...
      {
         var _loc1_:int = var_2510 * var_1445 + var_2511;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
