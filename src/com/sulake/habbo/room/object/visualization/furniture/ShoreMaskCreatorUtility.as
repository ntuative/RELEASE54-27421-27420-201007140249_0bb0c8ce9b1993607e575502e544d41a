package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_65:int = 2;
      
      public static const const_67:int = 1;
      ...
      {
         return param1 + param2 * const_1106;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_112,const_67,const_65,const_112,const_67,const_65];
                     _loc8_ = [const_67,const_67,const_67,const_65,const_65,const_65];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
