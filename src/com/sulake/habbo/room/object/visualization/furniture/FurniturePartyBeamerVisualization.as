package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_832:int = 15;
      
      private static const const_1185:int = 2;
      
      private static const const_373:int = 2;
      
      private static const const_831:int = 31;
      
      private static const const_1184:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1192[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1193[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1192 = new Array();
         var_1192.push(Math.random() * _loc2_ * 1.5);
         var_1192.push(Math.random() * _loc2_ * 1.5);
         var_1195 = new Array();
         var_1195.push(1);
         var_1195.push(-1);
         var_1194 = new Array();
         var_1194.push(const_1185);
         var_1194.push(const_1184);
         var_1193 = new Array();
         var_1193.push(getRandomAmplitudeFactor());
         var_1193.push(getRandomAmplitudeFactor());
      }
