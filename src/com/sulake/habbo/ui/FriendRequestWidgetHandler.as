package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_345;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_548);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_599);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_578);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_129:
            ...
            case FriendRequestEvent.const_262:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_548:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_34,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_599:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_578:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_129);
         _loc1_.push(FriendRequestEvent.const_53);
         _loc1_.push(FriendRequestEvent.const_262);
         return _loc1_;
      }
