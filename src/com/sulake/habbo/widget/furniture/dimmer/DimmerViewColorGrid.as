package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_445.destroyGridItems();
         var_327 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1385) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_541.width;
            _loc3_.height = var_541.height;
            var_445.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_541.width,var_541.height,true,0);
               _loc4_.bitmap.copyPixels(var_541,var_541.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_930.width,var_930.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_783.width,var_783.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_783,var_783.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_445.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_445.numGridItems)
         {
            return;
         }
         select(var_445.getGridItemAt(param1) as IWindowContainer);
      }
