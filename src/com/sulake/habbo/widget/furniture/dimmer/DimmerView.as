package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1374:XML;
      
      private var var_414:int;
      
      private var var_538:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2089:int;
      
      private var var_372:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_248.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_248.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_52,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1085,const_1086,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_538 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_372 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_248 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_248.numTabItems)
         {
            _loc6_ = var_248.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_38,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_538 != null)
         {
            var_538.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_248.selector.getSelected();
         return var_248.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_372 != null)
         {
            var_372.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1121 = _loc2_.light;
         if(var_372 != null)
         {
            var_372.setValue(var_1121);
         }
         var_414 = colors.indexOf(_loc2_.color);
         if(var_538 != null)
         {
            var_538.setSelectedColorIndex(var_414);
         }
