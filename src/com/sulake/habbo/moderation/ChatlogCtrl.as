package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1538:IMessageComposer;
      ...
      {
         var_903 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_902 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_51 = IItemListWindow(var_53.findChildByName("chatline_list"));
         var_53.procedure = onWindow;
         var _loc1_:IWindow = var_53.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1538);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_903.clone());
         ...
         {
            populateChatline(var_51,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_902.clone());
         _loc4_.color = var_1348[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(var_51.getListItemAt(_loc1_));
