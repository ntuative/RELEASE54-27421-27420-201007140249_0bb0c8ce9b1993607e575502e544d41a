package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_218:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_244:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_199:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_171:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_241:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_224:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_213:
               _loc4_ = "null";
               break;
            default:
               return;
