package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1729 = new RoomThumbnailRenderer(param1);
         var_901 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_182,var_118.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_182.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_182.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_901.refreshTags(_loc1_,var_118.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1729.refreshThumbnail(_loc1_,var_118.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_182 == null)
         {
            var_182 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_182.visible = true;
         Util.hideChildren(var_182);
         refreshRoomName(var_182,var_118);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_182,!true ? getEventCtg(var_118.categoryId) : getRoomCtg(var_118.categoryId));
         refreshRoomDesc(var_182,var_118);
         refreshExtraCont();
         refreshInfo(var_182,"trading_allowed",var_118.allowTrading);
         refreshInfo(var_182,"doormode_doorbell",false);
         refreshInfo(var_182,"doormode_password",false);
         Util.moveChildrenToColumn(var_182,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_182.height = Util.getLowestPoint(var_182);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_209,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
