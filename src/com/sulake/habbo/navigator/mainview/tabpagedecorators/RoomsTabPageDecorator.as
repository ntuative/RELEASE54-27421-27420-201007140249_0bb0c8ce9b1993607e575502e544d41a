package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_273,Tabs.const_325);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_273,Tabs.const_567);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_273,Tabs.const_325,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_537 == null)
         {
            var_537 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
