package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1135:int = -16;
      
      private static const const_792:int = 32;
      
      private static const const_1134:int = 8;
      
      public static const const_402:int = 10;
      ...
      private var var_916:ThumbnailImageConfigurations;
      
      private var var_1373:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_1119 = new Dictionary();
         super();
         _navigator = param1;
         var_916 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_35,0 | (!!param3 ? HabboWindowParam.const_38 : HabboWindowParam.const_35),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_916.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1135,_loc4_.y + const_1136 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2078[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_916.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_916.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_916.getImage(ThumbnailEditorModel.const_51,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_792 / 2);
         return new Point(param1 * const_792 + _loc3_,param2 * const_1134);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_402)
         {
            var_1119[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1119[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_402)
         {
            if(false)
            {
               refreshObj(param1,var_1119[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1373 == null)
         {
            var_1373 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1373,var_1373.rect,new Point(0,0),null,null,true);
      }
   }
}
