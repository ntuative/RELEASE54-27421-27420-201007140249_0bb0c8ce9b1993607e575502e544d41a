package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_230.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_230.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_230.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_230.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_230 != null)
               {
                  _loc3_ = var_230.category;
                  main.showUI(HabboHelpViewEnum.const_268);
                  main.tellUI(HabboHelpViewEnum.const_268,_loc3_);
               }
               break;
      ...
      private function getNextItem() : FaqItem
      {
         ...
         var _loc2_:FaqCategory = var_230.category;
         if(_loc2_ == null)
         {
            return null;
         }
