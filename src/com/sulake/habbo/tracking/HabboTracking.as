package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_814:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_257:LatencyTracker = null;
      ...
      private var var_991:LagWarningLogger = null;
      
      private var var_992:IHabboWindowManager;
      ...
      private var var_190:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_571 = new FramerateTracker();
         var_257 = new LatencyTracker();
         var_991 = new LagWarningLogger();
         var_1462 = new Array(const_814);
         var _loc4_:int = 0;
         while(_loc4_ < const_814)
         {
            var_1462[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1380,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1330,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1299,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_683,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1006,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_700:
               trackLoginStep(HabboLoginTrackingStep.const_1406,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_237:
               trackLoginStep(HabboLoginTrackingStep.const_237);
               break;
            ...
            case HabboCommunicationEvent.const_177:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_177);
               break;
            case HabboCommunicationEvent.const_202:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_202);
               if(var_257 != null)
               {
                  var_257.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_257 != null)
            {
               var_257.communication = _communication;
               var_257.connection = param1;
            }
            if(var_991 != null)
            {
               var_991.connection = param1;
            }
         }
      }
      ...
      {
         var_148 = IHabboConfigurationManager(param2);
         if(var_148)
         {
            Component(var_148).events.addEventListener(HabboConfigurationEvent.const_162,onConfigurationLoaded);
            if(var_257 != null)
            {
               var_257.configuration = var_148;
            }
            if(var_256 != null)
            {
               var_256.configuration = var_148;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_300.events.addEventListener(AdEvent.const_466,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1006,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_683,String(true));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_992)
            {
               var_992.release(new IIDHabboWindowManager());
               var_992 = null;
            }
            if(var_300)
            {
            ...
            if(var_190)
            {
               if(true)
               {
                  Component(var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_190).events.removeEventListener(HabboFriendListTrackingEvent.const_340,onFriendlistTrackingEvent);
               }
               var_190.release(new IIDHabboFriendList());
               var_190 = null;
            }
            if(var_164)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_237,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_177,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_160,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_202,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_543,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_60,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_425,onHotelViewEvent);
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_148)
         {
            if(var_991 != null)
            {
               var_991.configure(var_148);
            }
            if(var_571 != null)
            {
               var_571.configure(var_148);
            }
            Component(var_148).events.removeEventListener(HabboConfigurationEvent.const_162,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_90);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_90,onLocalizationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_889);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_889,onCoreRunning);
         }
      }
      ...
      {
         var_992 = IHabboWindowManager(param2);
         if(var_992)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1175 > -1 && _loc2_ < var_1175)
         {
            ++var_1687;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1687);
         }
         if(var_1175 > -1 && _loc2_ - var_1175 > 15000)
         {
            ++var_1688;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1688);
         }
         var_1175 = _loc2_;
         if(var_256 != null)
         {
         ...
         if(var_257 != null)
         {
            var_257.update(param1);
         }
         if(var_571 != null)
         {
            var_571.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_148 != null && !Boolean(var_148.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_256,onRoomAdClick);
      }
      ...
      {
         var_190 = param2 as IHabboFriendList;
         Component(var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_190).events.addEventListener(HabboFriendListTrackingEvent.const_340,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_148)
            {
               if(var_148.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_148.getKey("client.fatal.error.url");
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_90,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_543)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1390);
         }
         else if(param1.type == HabboHotelViewEvent.const_425)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1243);
         }
