package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1483:uint = 4.294967295E9;
      
      private const const_1484:uint = 4.293848814E9;
      
      private var var_862:int;
      
      private const const_1741:uint = 4.291613146E9;
      ...
      private var var_503:IWindowContainer;
      ...
      private const const_1740:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_730:
               showSelectors(false);
               break;
            case WindowEvent.const_621:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_231.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_863;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_863,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1484) : uint(const_1483);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1516;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_81);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_430,var_80,var_1057);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_231.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_863);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_604[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_603[var_201]);
         _catalog.purchaseProductAsGift(var_430,var_80,var_1057,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_138:
               ...
               for each(_loc7_ in var_245)
               {
                  ...
                  if(_loc5_.length >= const_1740)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1844 = _loc3_.text;
               break;
            case WindowMouseEvent.const_47:
               showSuggestions(false);
               if(var_1267)
               ...
               break;
            case WindowKeyboardEvent.const_588:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1516 = _loc1_.stuffTypes;
            var_604 = _loc1_.boxTypes;
            var_603 = _loc1_.ribbonTypes;
            var_863 = var_1516[0];
            _boxIndex = var_604[0];
            var_201 = var_603[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_231.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_231 == null)
         {
            var_231 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_503 == null)
         {
            var_503 = createWindow("suggestion_list_item") as IWindowContainer;
            var_503.procedure = suggestionsEventHandler;
         }
         if(var_231 == null || var_503 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_231.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_503.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
