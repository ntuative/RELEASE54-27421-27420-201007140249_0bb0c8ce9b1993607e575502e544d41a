package
{
   ...
   public class HabboInventoryCom extends SimpleApplication
   {
      ...
      public static var HabboInventory:Class = HabboInventory;
      ...
      public static var IIDHabboInventory:Class = IIDHabboInventory;
      ...
      public static var inventory_achievement_item_xml:Class = HabboInventoryCom_inventory_achievement_item_xml;
      
      public static var inventory_achievements_xml:Class = HabboInventoryCom_inventory_achievements_xml;
       
      
      public function HabboInventoryCom()
      {
         super();
      }
   }
