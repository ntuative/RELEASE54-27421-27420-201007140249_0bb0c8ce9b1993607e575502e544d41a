package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_15:String = "crash_time";
      
      public static const const_5:String = "background";
      
      public static const const_21:String = "client.init.core.init";
      ...
      public static const const_23:String = "client.init.core.fail";
      
      public static const const_14:String = "error_cat";
      ...
      public function Habbo()
      {
         ...
         var_6 = const_6[int(Math.random() * -1)];
      ...
      {
         trackLoginStep(const_9);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_9,const_8,null);
      }
