package
{
   ...
   public class HabboNotificationsCom extends SimpleApplication
   {
      ...
      public static var achievement_notification_xml:Class = HabboNotificationsCom_achievement_notification_xml;
      ...
      public static var IIDHabboNotifications:Class = IIDHabboNotifications;
      
      public static var layout_notification_xml:Class = HabboNotificationsCom_layout_notification_xml;
      
      public static var HabboNotifications:Class = HabboNotifications;
